...
const asientosOcupados = ["B-8", "C-3", "D-12", "E-7", "F-4", "G-9"];
...
function ReservasSala({ setModulo, menuOpen }) {
  ...
  return (
    <>
      {/* SOLO SE MUESTRA SI EL MENÚ NO ESTÁ ABIERTO */}
      {!menuOpen && (
        <button
          className="btn-regresar-fija"
          onClick={() => setModulo("cartelera")}
          aria-label="Regresar a cartelera"
        >
          <svg width="26" height="26" viewBox="0 0 28 28">
            <path d="M18 24l-8-10 8-10" stroke="#213" strokeWidth="3.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
      )}
